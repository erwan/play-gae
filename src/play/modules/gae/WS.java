 ...
 */
public class WS implements WSImpl {
    ...
    public class WSUrlfetchRequest extends WSRequest {
        ...
        public HttpResponse get() {
            try {
                return new HttpUrlfetchResponse(prepare(url, "GET"));
            } catch (Exception e) {
...
/*        @Override
        ...
        public HttpResponse post() {
            try {
                HttpURLConnection conn = prepare(url, "POST");
        ...
        public HttpResponse put() {
            try {
                return new HttpUrlfetchResponse(prepare(url, "PUT"));
            } catch (Exception e) {
                throw new RuntimeException(e);
            }
        }
       ...
       /** Execute a DELETE request.*/
        ...
        public HttpResponse delete() {
            try {
                return new HttpUrlfetchResponse(prepare(url, "DELETE"));
            } catch (Exception e) {
                throw new RuntimeException(e);
            }
        }
        ...
        public HttpResponse options() {
            try {
                return new HttpUrlfetchResponse(prepare(url, "OPTIONS"));
            } catch (Exception e) {
                throw new RuntimeException(e);
            }
        }
        ...
        public HttpResponse head() {
            try {
                return new HttpUrlfetchResponse(prepare(url, "HEAD"));
            } catch (Exception e) {
                throw new RuntimeException(e);
            }
        }
        ...
        public HttpResponse trace() {
            try {
                return new HttpUrlfetchResponse(prepare(url, "TRACE"));
            } catch (Exception e) {
                throw new RuntimeException(e);
            }
        }

        private HTTPRequest prepare(String url, String method) {
            try {
                ...
                for (String name: this.headers.keySet()) {
                    request.setHeader(new HTTPHeader(name, this.headers.get(name)));
                }
